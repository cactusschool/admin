...
@NamedQuery(name="AdminRoleAccess.findAll", query="SELECT r FROM AdminRoleAccess r")
...
public class AdminRoleAccess implements Serializable {
	...
	public AdminRoleMaster getRoleMaster() {
		return this.roleMaster;
	}

	public void setRoleMaster(AdminRoleMaster roleMaster) {
